...
** Attendance is one of the strongest factors associated with student exam performance.
**Students with higher study hours generally achieve better exam scores.
**Previous academic performance has a positive relationship with final exam scores.
**Students with better access to resources tend to perform better.
**Higher parental involvement is associated with better academic outcomes.
**Students with internet access have slightly higher average exam scores.
**Teacher quality and family income also show noticeable differences in average performance.
**Gender and school type show relatively small differences in exam scores.
